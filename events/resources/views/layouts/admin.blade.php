...
<head>
    ...
    <link rel="icon" href="{{ asset('/images/logotip-identiks-en.png') }}" type="image/x-icon">
    <link rel="shortcut icon" href="{{ asset('/images/logotip-identiks-en.png') }}" type="image/x-icon" />
