...
<fieldset class="form-group">
    ...
    <div class="form_show_audience_filter">
        ...
        <input type="radio" id="form_newsletter_enabled_0" name="newsletter_enabled"  class="custom-control-input"  checked="checked">
        <label class="custom-control-label  " for="form_newsletter_enabled_0">
               <span class="option"> Yes</span>
           </label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
        <input type="radio" id="newsletter_enabled-1" name="newsletter_enabled"  class="custom-control-input" value="no" >
