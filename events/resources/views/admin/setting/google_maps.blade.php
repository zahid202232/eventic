    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <small id="form_google_maps_api_key_help" class="form-text text-muted mb-3">
                ...
                <input type="text" id="form_google_maps_api_key" name="form[google_maps_api_key]" required="required"
                    aria-describedby="app_layout_settings_app_secret_help" class="form-control"
                    value="AIzaSyD9vrkLJKSv1SFSa-_ojqx3s8Q-uHM4U5Q">
