    ...
    <div class="card-body">
        ...
        <fieldset class="form-group">
            ...
            <div class="form_show_map_button">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="form_show_map_button_0" name="form[show_map_button]"
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="form_show_map_button_1" name="form[show_map_button]"
        ...
        <fieldset class="form-group">
            ...
            <div class="form_show_calender_button">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="form_show_calendar_button-0" name="show_calendar_button"
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="form_show_calendar_button-1" name="show_calendar_button"
                        class="custom-control-input" value="no">
        ...
        <fieldset class="form-group">
            ...
            <div class="form_show_rss_feed_button">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="form_show_rss_feed_button_0" name="show_rss_feed_button"
                        class="custom-control-input" checked="checked">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="form_show_rss_feed_button-1" name="show_rss_feed_button"
                        class="custom-control-input" value="no">
        ...
        <fieldset class="form-group">
            ...
            <div class="form_show_category_filter">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="form_show_category_filter_0" name="form_show_category_filter"
                        class="custom-control-input" checked="checked">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="form_show_category_filter-1" name="form_show_category_filter"
                        class="custom-control-input" value="no">
        ...
        <fieldset class="form-group">
            ...
            <div class="Show location filter">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="Show location filter_0" name="Show location filter"
                        class="custom-control-input" checked="checked">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="Show location filter-1" name="Show location filter"
                        class="custom-control-input" value="no">
        ...
        <fieldset class="form-group">
            ...
            <div class="form_show_date_filter">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="form_show_date_filter_0" name="form_show_date_filter"
                        class="custom-control-input" checked="checked">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="form_show_date_filter-1" name="form_show_date_filter"
                        class="custom-control-input" value="no">
        ...
        <fieldset class="form-group">
            ...
            <div class="form_show_ticket_price_filter">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="form_show_ticket_price_filter_0" name="form[show_ticket_price_filter]"
                        class="custom-control-input" checked="checked" vlaue="yes">
                    <label class="custom-control-label  " for="form_show_ticket_price_filter_0">
                        <span class="option"> Yes</span>
                    </label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="form_show_ticket_price_filter_1" name="form[show_ticket_price_filter]"
                        class="custom-control-input" value="no">
        ...
        <fieldset class="form-group">
            ...
            <div class="form_show_audience_filter">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" id="form_show_audience_filter_10" name="form_show_audience_filter"
                        class="custom-control-input" checked="checked" vlaue="yes">
