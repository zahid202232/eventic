...
<div class="card">
   ...
   <input id=demoInput type=number min=100 max=110 type="text" name="form[blog_posts_per_page]"   class="touchspin-integer form-control" value="9">
   ...
   <button onclick="decrement()" class="btn btn-primary bootstrap-touchspin-down " type="button">-</button>
    ...
    <div class="form_show_audience_filter">
        ...
        <input type="radio" id="form_show_audience_filter-0" name="form_show_audience_filter"  class="custom-control-input"  checked="checked" value="yes">
        ...
        <div class="custom-control custom-radio custom-control-inline">
        <input type="radio" id="form_show_audience_filter-2" name="form_show_audience_filter"  class="custom-control-input" value="dev" >
