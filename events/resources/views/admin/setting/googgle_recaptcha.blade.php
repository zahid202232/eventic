    ...
    <div class="card-body">
        <div class="col-lg-8 pt-8 pt-lg-0">
            <fieldset class="form-group">
                ...
                <div id="form_google_recaptcha_enabled">
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="form_google_recaptcha_enabled_16" name="form[google_recaptcha_enabled]"
                            required="required" class="custom-control-input" value="yes" checked="checked">
                    ...
                    <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" id="form_google_recaptcha_enabled_17" name="form[google_recaptcha_enabled]"
            ...
            <div class="form-group">
                ...
                <input type="text" id="form_google_recaptcha_site_key" name="form[google_recaptcha_site_key]"
                    class="form-control" value="6Ldio6wUAAAAAIp-aWdIxzMv24IA3qZv7-sibuS2">
            </div>
            <div class="form-group">
                <label for="form_google_recaptcha_secret_key" class="required">
                    Secret key
                </label>
                <input type="text" id="form_google_recaptcha_secret_key" name="form[google_recaptcha_secret_key]"
                    class="form-control" value="6Ldio6wUAAAAAIp-aWdIxzMv24IA3qZv7-sibuS2">
            </div>
            <div class="form-group">
