            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route("admin.participants.index") }}"
                        class="nav-link {{ request()->is("admin/participants") || request()->is("admin/participants/*") ? "active" : "" }}">
                        <i class="fa-fw nav-icon fas fa-users">
                ...
                <li
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route("setting.social_logins") }}"
                                class="nav-link {{ request()->is("admin/setting") || request()->is("admin/setting/*") ? "active" : "" }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route("setting.google_maps") }}"
                                class="nav-link {{ request()->is("admin/setting") || request()->is("admin/setting/*") ? "active" : "" }}">

                                <i class='fas nav-icon fa-globe'></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route("setting.googgle_recaptcha") }}"
                                class="nav-link {{ request()->is("admin/setting") || request()->is("admin/setting/*") ? "active" : "" }}">
                                <i class='fas nav-icon fa-desktop'></i>
                                <p>
                                    google recaptcha
                                </p>
                            </a>
